...
from sparse_recovery_bound import scores_for_depth, generate_latex_cross_val_table, find_optimal_parameters
...
# print("raw_scores_baseline_deep_30=", get_raw_scores([repo.get_entry('rp', 'corrective', 'r2', 'bidir', 'ffn')], pred_count=30))
...
# print("raw_scores_baseline_deep_60=", get_raw_scores([repo.get_entry('rp', 'corrective', 'r2', 'bidir', 'ffn')], pred_count=60))
...
# print("raw_scores_mixed_baseline_deep_30=", get_raw_scores([repo.get_entry('lp', 'corrective', 'r2'), repo.get_entry('lp', 'corrective', 'r2', 'ffn')], pred_count=30))
raw_scores_mixed_baseline_deep_30= {('lp', False, 'corrective', 'lp', 'r2', 'ffn'): {0: 1.0, 1: 0.994, 2: 0.977, 3: 0.938, 4: 0.898, 5: 0.801, 6: 0.745, 7: 0.678, 8: 0.679, 9: 0.669, 10: 0.663, 11: 0.636, 12: 0.628}, ('lp_star', False, 'corrective', 'lp', 'r2', 'ffn'): {0: 0.998, 1: 0.998, 2: 0.962, 3: 0.904, 4: 0.746, 5: 0.588, 6: 0.558, 7: 0.527, 8: 0.531, 9: 0.488, 10: 0.479, 11: 0.466, 12: 0.457}, ('rp', False, 'corrective', 'lp', 'r2', 'ffn'): {0: 0.992, 1: 0.999, 2: 0.977, 3: 0.871, 4: 0.742, 5: 0.623, 6: 0.601, 7: 0.619, 8: 0.616, 9: 0.618, 10: 0.621, 11: 0.605, 12: 0.597}, ('lp', True, 'corrective', 'lp', 'r2', 'ffn'): {0: 1.0, 1: 1.0, 2: 0.999, 3: 0.993, 4: 0.975, 5: 0.971, 6: 0.962, 7: 0.959, 8: 0.966, 9: 0.953, 10: 0.959, 11: 0.97, 12: 0.976}, ('lp_star', True, 'corrective', 'lp', 'r2', 'ffn'): {0: 0.993, 1: 0.999, 2: 0.997, 3: 0.978, 4: 0.957, 5: 0.938, 6: 0.923, 7: 0.882, 8: 0.866, 9: 0.848, 10: 0.803, 11: 0.772, 12: 0.748}, ('rp', True, 'corrective', 'lp', 'r2', 'ffn'): {0: 0.948, 1: 0.994, 2: 0.989, 3: 0.963, 4: 0.881, 5: 0.818, 6: 0.754, 7: 0.69, 8: 0.647, 9: 0.603, 10: 0.566, 11: 0.56, 12: 0.544}, ('lp', False, 'corrective', 'lp', 'r2'): {0: 1.0, 1: 0.996, 2: 0.974, 3: 0.946, 4: 0.881, 5: 0.811, 6: 0.748, 7: 0.682, 8: 0.702, 9: 0.683, 10: 0.685, 11: 0.671, 12: 0.65}, ('lp_star', False, 'corrective', 'lp', 'r2'): {0: 0.995, 1: 0.999, 2: 0.975, 3: 0.921, 4: 0.798, 5: 0.644, 6: 0.589, 7: 0.535, 8: 0.543, 9: 0.522, 10: 0.479, 11: 0.448, 12: 0.453}, ('rp', False, 'corrective', 'lp', 'r2'): {0: 0.85, 1: 0.997, 2: 0.971, 3: 0.903, 4: 0.758, 5: 0.634, 6: 0.618, 7: 0.613, 8: 0.618, 9: 0.608, 10: 0.604, 11: 0.613, 12: 0.607}, ('lp', True, 'corrective', 'lp', 'r2'): {0: 0.999, 1: 0.998, 2: 0.998, 3: 0.988, 4: 0.975, 5: 0.958, 6: 0.961, 7: 0.957, 8: 0.947, 9: 0.936, 10: 0.934, 11: 0.942, 12: 0.947}, ('lp_star', True, 'corrective', 'lp', 'r2'): {0: 0.996, 1: 0.999, 2: 0.996, 3: 0.974, 4: 0.954, 5: 0.914, 6: 0.891, 7: 0.875, 8: 0.792, 9: 0.792, 10: 0.749, 11: 0.701, 12: 0.657}, ('rp', True, 'corrective', 'lp', 'r2'): {0: 0.872, 1: 0.988, 2: 0.973, 3: 0.949, 4: 0.838, 5: 0.78, 6: 0.703, 7: 0.646, 8: 0.619, 9: 0.57, 10: 0.539, 11: 0.546, 12: 0.526}}
# print("raw_scores_mixed_deep_30=", get_raw_scores([x for x in repo.entries if {'lp', 'direct', 'cot', 'r2'} <= x.tags], pred_count=30))
raw_scores_mixed_deep_30= {('lp', False, 'lp', 'r2', 'direct', 'cot'): {0: 1.0, 1: 0.954, 2: 0.8, 3: 0.736, 4: 0.692, 5: 0.699, 6: 0.677, 7: 0.631, 8: 0.614, 9: 0.628, 10: 0.605, 11: 0.583, 12: 0.565}, ('lp_star', False, 'lp', 'r2', 'direct', 'cot'): {0: 0.988, 1: 0.958, 2: 0.744, 3: 0.65, 4: 0.626, 5: 0.586, 6: 0.593, 7: 0.58, 8: 0.589, 9: 0.547, 10: 0.527, 11: 0.508, 12: 0.489}, ('rp', False, 'lp', 'r2', 'direct', 'cot'): {0: 0.962, 1: 0.954, 2: 0.762, 3: 0.665, 4: 0.631, 5: 0.628, 6: 0.613, 7: 0.622, 8: 0.613, 9: 0.612, 10: 0.616, 11: 0.627, 12: 0.626}, ('lp', True, 'lp', 'r2', 'direct', 'cot'): {0: 1.0, 1: 0.954, 2: 0.803, 3: 0.736, 4: 0.693, 5: 0.699, 6: 0.676, 7: 0.631, 8: 0.613, 9: 0.629, 10: 0.606, 11: 0.583, 12: 0.565}, ('lp_star', True, 'lp', 'r2', 'direct', 'cot'): {0: 0.988, 1: 0.959, 2: 0.742, 3: 0.65, 4: 0.626, 5: 0.585, 6: 0.591, 7: 0.578, 8: 0.585, 9: 0.546, 10: 0.525, 11: 0.505, 12: 0.489}, ('rp', True, 'lp', 'r2', 'direct', 'cot'): {0: 0.963, 1: 0.954, 2: 0.764, 3: 0.663, 4: 0.632, 5: 0.626, 6: 0.612, 7: 0.624, 8: 0.613, 9: 0.612, 10: 0.618, 11: 0.627, 12: 0.626}, ('lp', False, 'r2', 'lp', 'ffn', 'cot', 'direct'): {0: 0.512, 1: 0.549, 2: 0.528, 3: 0.508, 4: 0.511, 5: 0.506, 6: 0.515, 7: 0.504, 8: 0.499, 9: 0.508, 10: 0.511, 11: 0.497, 12: 0.496}, ('lp_star', False, 'r2', 'lp', 'ffn', 'cot', 'direct'): {0: 0.714, 1: 0.65, 2: 0.591, 3: 0.54, 4: 0.554, 5: 0.536, 6: 0.54, 7: 0.515, 8: 0.512, 9: 0.506, 10: 0.512, 11: 0.502, 12: 0.516}, ('rp', False, 'r2', 'lp', 'ffn', 'cot', 'direct'): {0: 0.561, 1: 0.612, 2: 0.606, 3: 0.605, 4: 0.599, 5: 0.584, 6: 0.586, 7: 0.589, 8: 0.598, 9: 0.576, 10: 0.561, 11: 0.561, 12: 0.547}, ('lp', True, 'r2', 'lp', 'ffn', 'cot', 'direct'): {0: 0.512, 1: 0.548, 2: 0.528, 3: 0.507, 4: 0.511, 5: 0.506, 6: 0.515, 7: 0.504, 8: 0.499, 9: 0.508, 10: 0.511, 11: 0.497, 12: 0.496}, ('lp_star', True, 'r2', 'lp', 'ffn', 'cot', 'direct'): {0: 0.714, 1: 0.65, 2: 0.591, 3: 0.54, 4: 0.554, 5: 0.536, 6: 0.541, 7: 0.515, 8: 0.511, 9: 0.505, 10: 0.512, 11: 0.502, 12: 0.516}, ('rp', True, 'r2', 'lp', 'ffn', 'cot', 'direct'): {0: 0.56, 1: 0.612, 2: 0.606, 3: 0.606, 4: 0.599, 5: 0.584, 6: 0.586, 7: 0.589, 8: 0.598, 9: 0.576, 10: 0.562, 11: 0.561, 12: 0.547}}
# print(generate_comparison_table(raw_scores_mixed_baseline_deep_30, raw_scores_mixed_deep_30))
...
###### Width ######
# print("raw_scores_width=", get_ablation_scores([x for x in repo.entries if {'rp', 'width'} <= x.tags], include_cot=False))
raw_scores_width= {('validation_rp_balanced', False, 'r2', 'dim=128', 'width', 'layers=8', 'rp', 'heads=2', 'bidir', 'corrective'): {0: 1.0, 1: 0.999, 2: 0.983, 3: 0.955, 4: 0.924, 5: 0.899, 6: 0.867}, ('validation_lp_balanced', False, 'r2', 'dim=128', 'width', 'layers=8', 'rp', 'heads=2', 'bidir', 'corrective'): {0: 0.999, 1: 0.976, 2: 0.881, 3: 0.754, 4: 0.641, 5: 0.606, 6: 0.601}, ('validation_rp_balanced_3_premise', False, 'r2', 'dim=128', 'width', 'layers=8', 'rp', 'heads=2', 'bidir', 'corrective'): {0: 0.999, 1: 0.984, 2: 0.943, 3: 0.853, 4: 0.791, 5: 0.705, 6: 0.624}, ('validation_rp_balanced_2_premise', False, 'r2', 'dim=128', 'width', 'layers=8', 'rp', 'heads=2', 'bidir', 'corrective'): {0: 1.0, 1: 0.998, 2: 0.981, 3: 0.96, 4: 0.919, 5: 0.88, 6: 0.84}, ('validation_rp_balanced_1_premise', False, 'r2', 'dim=128', 'width', 'layers=8', 'rp', 'heads=2', 'bidir', 'corrective'): {0: 0.994, 1: 0.994, 2: 0.987, 3: 0.968, 4: 0.948, 5: 0.903, 6: 0.893}, ('validation_rp_balanced_1_2_premise', False, 'r2', 'dim=128', 'width', 'layers=8', 'rp', 'heads=2', 'bidir', 'corrective'): {0: 0.999, 1: 0.998, 2: 0.985, 3: 0.964, 4: 0.942, 5: 0.939, 6: 0.907}, ('validation_rp_balanced_2_3_premise', False, 'r2', 'dim=128', 'width', 'layers=8', 'rp', 'heads=2', 'bidir', 'corrective'): {0: 0.999, 1: 0.995, 2: 0.96, 3: 0.952, 4: 0.871, 5: 0.808, 6: 0.721}, ('validation_rp_balanced', False, 'r2', 'heads=4', 'dim=128', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 0.999, 2: 0.992, 3: 0.968, 4: 0.93, 5: 0.918, 6: 0.893}, ('validation_lp_balanced', False, 'r2', 'heads=4', 'dim=128', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 0.961, 2: 0.864, 3: 0.717, 4: 0.624, 5: 0.598, 6: 0.556}, ('validation_rp_balanced_3_premise', False, 'r2', 'heads=4', 'dim=128', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 0.992, 2: 0.985, 3: 0.931, 4: 0.899, 5: 0.838, 6: 0.794}, ('validation_rp_balanced_2_premise', False, 'r2', 'heads=4', 'dim=128', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 0.997, 2: 0.992, 3: 0.965, 4: 0.941, 5: 0.905, 6: 0.855}, ('validation_rp_balanced_1_premise', False, 'r2', 'heads=4', 'dim=128', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 0.999, 1: 0.999, 2: 0.995, 3: 0.985, 4: 0.968, 5: 0.963, 6: 0.953}, ('validation_rp_balanced_1_2_premise', False, 'r2', 'heads=4', 'dim=128', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 0.999, 2: 0.992, 3: 0.97, 4: 0.96, 5: 0.951, 6: 0.929}, ('validation_rp_balanced_2_3_premise', False, 'r2', 'heads=4', 'dim=128', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 0.994, 2: 0.989, 3: 0.951, 4: 0.903, 5: 0.882, 6: 0.82}, ('validation_rp_balanced', False, 'r2', 'dim=256', 'heads=4', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 0.997, 3: 0.996, 4: 0.989, 5: 0.968, 6: 0.953}, ('validation_lp_balanced', False, 'r2', 'dim=256', 'heads=4', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 0.999, 2: 0.974, 3: 0.91, 4: 0.822, 5: 0.704, 6: 0.631}, ('validation_rp_balanced_3_premise', False, 'r2', 'dim=256', 'heads=4', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 0.999, 2: 0.999, 3: 0.992, 4: 0.958, 5: 0.904, 6: 0.824}, ('validation_rp_balanced_2_premise', False, 'r2', 'dim=256', 'heads=4', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 0.999, 2: 1.0, 3: 0.991, 4: 0.979, 5: 0.964, 6: 0.937}, ('validation_rp_balanced_1_premise', False, 'r2', 'dim=256', 'heads=4', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 0.986, 1: 1.0, 2: 0.997, 3: 0.998, 4: 0.99, 5: 0.977, 6: 0.947}, ('validation_rp_balanced_1_2_premise', False, 'r2', 'dim=256', 'heads=4', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 1.0, 3: 0.992, 4: 0.983, 5: 0.98, 6: 0.956}, ('validation_rp_balanced_2_3_premise', False, 'r2', 'dim=256', 'heads=4', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 0.996, 3: 0.989, 4: 0.973, 5: 0.942, 6: 0.894}, ('validation_rp_balanced', False, 'heads=6', 'r2', 'dim=384', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 0.999, 3: 0.997, 4: 0.997, 5: 0.995, 6: 0.976}, ('validation_lp_balanced', False, 'heads=6', 'r2', 'dim=384', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 0.999, 2: 0.993, 3: 0.976, 4: 0.938, 5: 0.847, 6: 0.765}, ('validation_rp_balanced_3_premise', False, 'heads=6', 'r2', 'dim=384', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 0.998, 1: 1.0, 2: 1.0, 3: 0.994, 4: 0.983, 5: 0.936, 6: 0.856}, ('validation_rp_balanced_2_premise', False, 'heads=6', 'r2', 'dim=384', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 1.0, 3: 0.998, 4: 0.996, 5: 0.989, 6: 0.96}, ('validation_rp_balanced_1_premise', False, 'heads=6', 'r2', 'dim=384', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 1.0, 3: 0.999, 4: 0.999, 5: 0.994, 6: 0.98}, ('validation_rp_balanced_1_2_premise', False, 'heads=6', 'r2', 'dim=384', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 0.999, 3: 0.997, 4: 0.996, 5: 0.996, 6: 0.987}, ('validation_rp_balanced_2_3_premise', False, 'heads=6', 'r2', 'dim=384', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 0.999, 3: 0.997, 4: 0.99, 5: 0.977, 6: 0.943}, ('validation_rp_balanced', False, 'r2', 'heads=4', 'dim=512', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 1.0, 3: 0.996, 4: 0.992, 5: 0.979, 6: 0.974}, ('validation_lp_balanced', False, 'r2', 'heads=4', 'dim=512', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 0.998, 2: 0.986, 3: 0.941, 4: 0.87, 5: 0.751, 6: 0.643}, ('validation_rp_balanced_3_premise', False, 'r2', 'heads=4', 'dim=512', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 0.999, 3: 0.993, 4: 0.971, 5: 0.939, 6: 0.881}, ('validation_rp_balanced_2_premise', False, 'r2', 'heads=4', 'dim=512', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 1.0, 3: 0.995, 4: 0.987, 5: 0.982, 6: 0.957}, ('validation_rp_balanced_1_premise', False, 'r2', 'heads=4', 'dim=512', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 0.994, 1: 1.0, 2: 1.0, 3: 0.998, 4: 0.994, 5: 0.996, 6: 0.987}, ('validation_rp_balanced_1_2_premise', False, 'r2', 'heads=4', 'dim=512', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 1.0, 3: 0.994, 4: 0.992, 5: 0.986, 6: 0.974}, ('validation_rp_balanced_2_3_premise', False, 'r2', 'heads=4', 'dim=512', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 0.999, 3: 0.998, 4: 0.979, 5: 0.967, 6: 0.921}, ('validation_rp_balanced', False, 'r2', 'dim=512', 'heads=8', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 1.0, 3: 0.998, 4: 0.992, 5: 0.989, 6: 0.97}, ('validation_lp_balanced', False, 'r2', 'dim=512', 'heads=8', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 0.994, 3: 0.965, 4: 0.861, 5: 0.779, 6: 0.698}, ('validation_rp_balanced_3_premise', False, 'r2', 'dim=512', 'heads=8', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 0.999, 2: 1.0, 3: 0.998, 4: 0.972, 5: 0.948, 6: 0.894}, ('validation_rp_balanced_2_premise', False, 'r2', 'dim=512', 'heads=8', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 1.0, 3: 0.997, 4: 0.991, 5: 0.987, 6: 0.974}, ('validation_rp_balanced_1_premise', False, 'r2', 'dim=512', 'heads=8', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 0.969, 1: 1.0, 2: 1.0, 3: 1.0, 4: 0.996, 5: 0.995, 6: 0.993}, ('validation_rp_balanced_1_2_premise', False, 'r2', 'dim=512', 'heads=8', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 1.0, 3: 0.995, 4: 0.991, 5: 0.993, 6: 0.986}, ('validation_rp_balanced_2_3_premise', False, 'r2', 'dim=512', 'heads=8', 'width', 'layers=8', 'rp', 'bidir', 'corrective'): {0: 1.0, 1: 1.0, 2: 1.0, 3: 0.997, 4: 0.985, 5: 0.973, 6: 0.953}, ('validation_rp_balanced', False, 'r2', 'heads=1', 'width', 'layers=8', 'rp', 'bidir', 'dim=64', 'corrective'): {0: 0.999, 1: 0.983, 2: 0.918, 3: 0.852, 4: 0.846, 5: 0.823, 6: 0.795}, ('validation_lp_balanced', False, 'r2', 'heads=1', 'width', 'layers=8', 'rp', 'bidir', 'dim=64', 'corrective'): {0: 0.985, 1: 0.837, 2: 0.68, 3: 0.597, 4: 0.557, 5: 0.562, 6: 0.562}, ('validation_rp_balanced_3_premise', False, 'r2', 'heads=1', 'width', 'layers=8', 'rp', 'bidir', 'dim=64', 'corrective'): {0: 1.0, 1: 0.969, 2: 0.903, 3: 0.773, 4: 0.747, 5: 0.678, 6: 0.616}, ('validation_rp_balanced_2_premise', False, 'r2', 'heads=1', 'width', 'layers=8', 'rp', 'bidir', 'dim=64', 'corrective'): {0: 1.0, 1: 0.982, 2: 0.921, 3: 0.848, 4: 0.797, 5: 0.764, 6: 0.741}, ('validation_rp_balanced_1_premise', False, 'r2', 'heads=1', 'width', 'layers=8', 'rp', 'bidir', 'dim=64', 'corrective'): {0: 0.938, 1: 0.981, 2: 0.95, 3: 0.921, 4: 0.89, 5: 0.867, 6: 0.855}, ('validation_rp_balanced_1_2_premise', False, 'r2', 'heads=1', 'width', 'layers=8', 'rp', 'bidir', 'dim=64', 'corrective'): {0: 0.984, 1: 0.973, 2: 0.933, 3: 0.893, 4: 0.869, 5: 0.853, 6: 0.854}, ('validation_rp_balanced_2_3_premise', False, 'r2', 'heads=1', 'width', 'layers=8', 'rp', 'bidir', 'dim=64', 'corrective'): {0: 0.999, 1: 0.973, 2: 0.923, 3: 0.849, 4: 0.785, 5: 0.729, 6: 0.69}}
dataset_s_map = {
    'validation_rp_balanced_1_premise': 1.0,
    'validation_rp_balanced': 1.5,
    'validation_rp_balanced_2_premise': 2.0,
    'validation_rp_balanced_3_premise': 3.0
}
# find_optimal_parameters(scores_for_depth(raw_scores_width, target_depth=6), dataset_s_map)
# print(generate_latex_cross_val_table(scores_for_depth(raw_scores_width, target_depth=6), dataset_s_map, 650, 1, 0))
