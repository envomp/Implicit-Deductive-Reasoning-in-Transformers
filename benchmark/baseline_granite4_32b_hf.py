from conf import *
from benchmark.hf_models import load_granite4_32b
from benchmark.baseline import run_baselines

granite, tokenizer = load_granite4_32b()
...
run_baselines(granite, "granite4_32B", datasets, prompt_formats, preprocess_fn=preprocess_fn, decode_fn=decode_fn)
